...
def deal_path(outer_boundary, p2p_safe_distance, center_point_distance, request_num):
    ...
    for center_point in turning_point:
        ...
        try:
            ...
            r = 90  # 角度
            find_cnt, find_array = find_point(center_point, r, zoom_array, center_point_distance, request_num, p2p_safe_distance, path_array, city_list)
            ...
            if len(find_array) != 4:
                ...
                center_point_distance2 = center_point_distance - 3
                # 求出终点坐标 e_x = d * cos; e_y = d * sin
                r = 90  # 角度
                find_cnt, find_array = find_point(center_point, r, zoom_array, center_point_distance2, request_num,p2p_safe_distance, path_array, city_list)
                while len(find_array) < 4 and r > 0:
                    r = r - 3
                    # print(r)
                    find_cnt, find_array = find_point(center_point, r, zoom_array, center_point_distance2, request_num, p2p_safe_distance, path_array, city_list)
...
def find_point(center_point, r, zoom_array, center_point_distance, request_num, p2p_safe_distance, path_array, city_list):
    find_array = list()
    re = 0  # 起始角度
    find_cnt = 0
    # max = int(360 / r)
