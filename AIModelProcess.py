...
def main(separator='\t'):
    ...
    #                 print("\t".join([dateline, batchno, userid, accid, areaid, logindate, heroId, str(ce), str(heroLevel), str(heroStar),str(heroSkin), str(heroStep), str(weaponLevel),str(weaponUpInfo)]))
